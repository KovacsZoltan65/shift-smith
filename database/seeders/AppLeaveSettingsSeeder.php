    ...
    public function run(): void
    {
        ...
        $rows = [
            ...
            [
                ...
                'value' => json_encode([
                    // age => extra days, stored as minutes
                    ['age' => 25, 'extra_minutes_per_year' => 1 * $minutesPerDay],
                    ['age' => 28, 'extra_minutes_per_year' => 2 * $minutesPerDay],
                    ['age' => 31, 'extra_minutes_per_year' => 3 * $minutesPerDay],
                    ['age' => 33, 'extra_minutes_per_year' => 4 * $minutesPerDay],
                    ['age' => 35, 'extra_minutes_per_year' => 5 * $minutesPerDay],
                    ['age' => 37, 'extra_minutes_per_year' => 6 * $minutesPerDay],
                    ['age' => 39, 'extra_minutes_per_year' => 7 * $minutesPerDay],
                    ['age' => 41, 'extra_minutes_per_year' => 8 * $minutesPerDay],
                    ['age' => 43, 'extra_minutes_per_year' => 9 * $minutesPerDay],
                    ['age' => 45, 'extra_minutes_per_year' => 10 * $minutesPerDay],
                ]),
                'type' => 'json',
                'group' => 'leave',
                'label' => 'Age-based bonus leave table',
                'description' => 'Age thresholds and extra leave minutes/year.',
            ],
            [
