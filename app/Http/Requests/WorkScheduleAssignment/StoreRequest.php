...
/**
 * Új WorkScheduleAssignment létrehozási kérés.
 */
class StoreRequest extends FormRequest
{
     ...
     *
     * @return bool True, ha a felhasználó létrehozhat kiosztást.
     */
    public function authorize(): bool
    {
        return $this->user()?->can(WorkScheduleAssignmentPolicy::PERM_CREATE, WorkScheduleAssignment::class) ?? false;
    }
     ...
     * - employee és shift ugyanahhoz a céghez tartozzon
     *
    ...
    /**
     * Létrehozási payload előállítása repository részére.
     *
     * @return array{
     *   company_id: int,
    ...
    /**
     * Aktuális route schedule tenant-safe feloldása.
     *
