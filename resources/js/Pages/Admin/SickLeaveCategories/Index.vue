...
import DeleteModal from "@/Pages/Admin/SickLeaveCategories/Partials/DeleteModal.vue";
import EditModal from "@/Pages/Admin/SickLeaveCategories/Partials/EditModal.vue";
...
const canDelete = computed(() => has("sick_leave_categories.delete"));
...
const fetchRows = async () => {
    ...
    try {
        const { data } = await SickLeaveCategoryService.fetch({
            perPage: 100,
            sortBy: "order_index",
            sortDir: "asc",
        });
            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <Button
                        ...
                        size="small"
                        :loading="loading"
                        data-testid="sick-leave-categories-refresh"
                        @click="fetchRows"
                    />
                </div>
            </div>
                    ...
                    <template #body="{ data }">
                        <div class="flex justify-end gap-2">
                            <Button
                                ...
                                size="small"
                                :disabled="loading"
                                data-testid="sick-leave-categories-actions"
