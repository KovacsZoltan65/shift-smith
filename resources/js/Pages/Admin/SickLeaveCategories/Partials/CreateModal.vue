...
<template>
    <Dialog
        ...
        modal
        header="Új betegszabadság kategória"
        :style="{ width: '42rem' }"
        :closable="!saving"
        :dismissableMask="!saving"
    >
        <SickLeaveCategoryFields v-model="form" :errors="errors" :disabled="saving" />
        ...
        <template #footer>
            <div class="flex justify-end gap-2">
                ...
                <Button
                    ...
                    data-testid="sick-leave-category-create-save"
                    @click="submit"
                />
            </div>
        </template>
