...
<template>
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
            <label class="mb-1 block text-sm">Kód</label>
            <InputText
                class="w-full"
                :modelValue="modelValue?.code ?? 'Automatikusan generalodik'"
                readonly
                :disabled="disabled || !isEdit"
                data-testid="sick-leave-category-code"
            />
        ...
        <div>
            ...
            <InputText
                ...
                :disabled="disabled"
                data-testid="sick-leave-category-name"
        ...
        <div class="md:col-span-2">
            <label class="mb-1 block text-sm">Leírás</label>
            <Textarea
                class="w-full"
                rows="4"
                :modelValue="modelValue?.description ?? ''"
                :disabled="disabled"
                data-testid="sick-leave-category-description"
        ...
        <div>
            ...
            <InputNumber
                ...
                :max="100000"
                showButtons
                inputId="sick-leave-category-order-index"
                data-testid="sick-leave-category-order-index"
                :disabled="disabled"
        ...
        <div class="flex items-center pt-7">
            <label class="flex items-center gap-2 text-sm">
                <Checkbox
                    inputId="sick-leave-category-active"
                    :modelValue="!!modelValue?.active"
                    binary
                    :disabled="disabled"
                    data-testid="sick-leave-category-active"
